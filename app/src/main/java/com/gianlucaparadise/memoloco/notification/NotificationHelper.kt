package com.gianlucaparadise.memoloco.notification
...
import com.gianlucaparadise.memoloco.MainActivity
...
class NotificationHelper @Inject constructor(@ApplicationContext val context: Context) {
    ...
    companion object {
        private const val channelId = "memo-loco-notifications"
